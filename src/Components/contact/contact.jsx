  ...
  return (
    <div className='contact-container flxrow' id='contact'>
        ...
        <div className="contact-details-container flxcln">
          <h1>Contact Us</h1>
          <div className="contact-row-container flxrow"><img src={callIcn} alt="" className="contact-icon" /><a href='tel:+39 3511369102' className="contact-a">+39 3511369102</a></div>
